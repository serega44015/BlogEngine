...
public interface PostMapper {
    ...
    @Mapping(target = "dislikeCount", source = "post.postVoteList", qualifiedByName = "dislikesAmount")
    @Mapping(target = "commentCount", source = "post.postCommentList", qualifiedByName = "commentCount")
    ...
    @Mapping(target = "isActive", source = "createPostRequest.active", qualifiedByName = "postIntIsActive")
